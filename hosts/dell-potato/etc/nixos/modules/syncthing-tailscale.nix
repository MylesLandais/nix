...

{
  ...
  networking.interfaces = {
    # You may need to adjust the interface name (check with: ip link show)
    # Common names: enp0s3, eth0, eno1, etc.
    # Uncomment and adjust the interface name below:
    # enp0s3.wakeOnLan.enable = true;
