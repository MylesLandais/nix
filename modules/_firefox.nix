    ...
    programs.firefox = {
      ...
      profiles.default = {
        ...
        extensions.packages = with pkgs.nur.repos.rycee.firefox-addons; [
          ublock-origin
          bitwarden
          # plasma-integration # TODO: Issue with integrating with Hypr, can enable is using KDE
          darkreader
          # privacy-badger
          # noscript
        ];
        ...
        settings = cfg.preferences // {
          ...
          "media.ffmpeg.vaapi.enabled" = cfg.preferences."media.ffmpeg.vaapi.enabled" or false;
